...
const AddBasket = ({ post }) => {
    ...
    const [show, setShow] = useState(basket.products.filter((item) => item.id === post.id))

    return (
        <div>
            {
                !show ?
                    <button onClick={() => { }} className={style.productsPage__addToBasket}>
                    ...
                    <button onClick={() => {
                        ...
                        setShow(basket.products.filter((item) => item.id === post.id))
