...
const ProductsPage = () => {
    ...
    return (
        <div className="container">
            {data.map(item => {
                return <div key={item.id} className={style.productsPage}>
                    ...
                    <div className={style.productsPage__text}>
                        ...
                        <div className={style.productsPage__price}>
                            <p className={style.productsPage__priceNew}>
                                {item.colors[0].current_price} р
                                <span className={style.productsPage__priceOld}>{item.colors[0].price} р</span>
                            </p>
                        </div>
