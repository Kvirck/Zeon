    ...
    return (
        <div className={style.basket__product}>
            <div className={style.basket__product__img}>
                <img src={`http://localhost${product.colors[0].images[0]}`} alt="imgProduct" />
            </div>
            <div className={style.basket__product__info}>
                ...
                <p className={style.basket__product__size}>Размер: <span>{product.colors[0].size}</span></p>
                <p className={style.basket__product__color}>Цвет: </p>
                <div className={style.basket__product__price}>
                    <p className={style.basket__product__priceNew}>
                        {product.colors[0].current_price} {product.colors[0].current_price ? ' р ' : ''}
                        <span className={product.colors[0].current_price ? style.basket__product__priceOld : style.basket__product__priceNew}>
                            {product.colors[0].price} р</span>
                    </p>
                </div>
