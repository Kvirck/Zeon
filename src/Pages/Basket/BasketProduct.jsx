    ...
    return (
        <div className={style.basket__product}>
            <div className={style.basket__product__img}>
                <img src="/img/Rectangle491.png" alt="imgProduct" />
            </div>
            <div className={style.basket__product__info}>
                ...
                <p className={style.basket__product__size}>Размер: <span>{props.sizeProduct}</span></p>
                <p className={style.basket__product__color}>Цвет: </p>
                <div className={style.basket__product__price} >
                    <p className={style.basket__product__priceNew}>{props.priceNew}</p>
                    <p className={style.basket__product__priceOld}>{props.priceOld}</p>
                </div>
